...
TEXT = {
    "en": {
        ...
        "clicks_video_help": "Estimated product-page clicks generated by each creator video during the organic click window. Current value is a planning benchmark; align with your AM using similar-category TikTok Shop data where available.",
        ...
        "benchmark_info_text": "Current AOV, video, click, conversion, and ShopTab assumptions are planning benchmarks. We recommend aligning with your AM and using TikTok Shop data from similar categories or merchants in your industry as inputs.",
    ...
    "zh": {
        ...
        "clicks_video_help": "每条达人视频在自然点击消耗周期内预计带来的商品页点击数。当前为 planning benchmark，建议和您的 AM 对齐，参考 TikTok Shop 上类似行业或类似商家的数据进行输入。",
        ...
        "health_shoptab": "至少一个 SKU 的 ShopTab GMV 占比较高，建议和您的 AM 对齐，参考类似行业或类似商家的数据后再作为正式预测。",
        ...
        "benchmark_info": "数据说明",
        "benchmark_info_text": "当前 AOV、视频、点击、转化率和 ShopTab 占比是 planning benchmark。建议和您的 AM 对齐，参考 TikTok Shop 上类似行业或类似商家的数据进行输入。",
...
TEXT["de"] = {
    **TEXT["en"],
    ...
    "shoptab_share_help": "Anteil des organischen GMV, der nach Content-Einfluss über ShopTab/Search/Mall/Storefront kauft. Dieser GMV trägt keine Creator-Provision. Bitte mit dem AM anhand ähnlicher TikTok-Shop-Kategorien oder Händler abstimmen.",
...
TEXT["nl"] = {
    **TEXT["en"],
    ...
    "shoptab_share_help": "Aandeel organische GMV dat na content-invloed via ShopTab/Search/Mall/Storefront koopt. Deze GMV heeft geen creator commissie. Stem dit af met de AM op basis van vergelijkbare TikTok Shop-categorieen of merchants.",
...
def build_customer_summary(overall, phase_summary, weekly_be_label, cumulative_be_label, meeting_notes, assumption_status, cost_explanation_text):
    rows = [
...
def meeting_recap_html(overall, narrative, health_checks, path_text, weeks, skus, generated_at, meeting_notes, assumption_status, takeaways, cost_explanation_text):
...
def meeting_summary_pdf(overall, narrative, health_checks, path_text, weeks, skus, generated_at, meeting_notes, assumption_status, takeaways, cost_explanation_text):
