...
TEXT = {
    "en": {
        ...
        "shoptab_share_help": "Share of organic GMV attributed to ShopTab/Search/Mall/Storefront after users are influenced by content. This GMV does not carry creator affiliate commission. Align this input with your AM using similar-category TikTok Shop data where available.",
    ...
    "zh": {
        ...
        "shoptab_share_help": "被内容种草后，最终通过 ShopTab/Search/Mall/店铺页成交的 organic GMV 占比。这部分 GMV 不产生达人佣金。建议和您的 AM 对齐，参考 TikTok Shop 上类似行业或类似商家的数据进行输入。",
